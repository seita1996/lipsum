...
const generateEnglishDummyText = (numberOfChars: number): string => {
  ...
  const words = [
    ...
    "over", "part", "place", "point", "power", "right", "same", "seen", "side", "since", "small",
    "some", "sound", "still", "study", "such", "take", "than", "that", "their", "them", "then",
    "there", "these", "they", "thing", "think", "this", "those", "three", "time", "under", "very",
    "water", "way", "well", "were", "what", "when", "where", "which", "while", "who", "will",
    "with", "work", "world", "would", "year", "your",
    // Longer words (7+ chars)
    "another", "because", "between", "building", "business", "children", "community", "computer",
    "consider", "continue", "creative", "cultural", "different", "discover", "education", "everyone",
    "experience", "following", "government", "important", "including", "information", "knowledge",
    "learning", "material", "national", "necessary", "original", "personal", "possible", "practice",
    "question", "research", "resource", "something", "sometimes", "structure", "together", "understand"
  ];

  // Common punctuation and sentence structures
  const punctuation = [".", ".", ".", ".", "?", "!", ",", ";", ":"];
  const sentenceStarters = [
    "The", "A", "In", "When", "If", "Although", "While", "Since", "Because", "As", "After",
    "Before", "However", "Therefore", "Consequently", "Nevertheless", "Moreover", "Furthermore"
  ];
